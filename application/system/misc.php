...
//to_arr contains an array of email addresses you want to pester
function debug_email($subject, $message, $to_arr) {

    $headers = 'From: debug@amsmeteors.org' . "\r\n" .
        'Reply-To: debug@amsmeteors.org' . "\r\n" .
        'X-Mailer: PHP/' . phpversion();

    foreach($to_arr as $to) {
        if(!empty($subject)) {
            //mail($to, $subject, $message, $headers);
            Mail::send($to, 'debug@amsmeteors.org', $subject, $message, $headers);
        }
    }
}
