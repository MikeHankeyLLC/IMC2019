...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=be6870a51867027f9b44)
 * Config saved to config.json and https://gist.github.com/be6870a51867027f9b44
 */
...
function init_datepickers() {
   $('input[name=dob]').datepicker({
        format: "yyyy-mm-dd",
        defaultViewDate: { year: 1976, month: 08, day: 10 }
   });
}
